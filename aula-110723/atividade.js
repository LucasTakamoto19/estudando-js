...
num = 24.2579;
console.log(num + " arrendondado para o mais próximo é " + Math.round(num));
...
console.log("Número randomico: " + numRandom);

// Arredonde um número para um número específico de casas decimais.

num = 56.78634342;
console.log(num + " arredondando para duas casas decimais: " + num.toFixed(2));
...
console.log(num + " arrendondando para o anterior: " + numArrend);
